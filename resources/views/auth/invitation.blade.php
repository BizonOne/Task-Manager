...
<head>
    ...
    <title>Accept Invitation — {{ \App\Support\Brand::name() }}</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lc-wrap { width: 100%; max-width: 420px; }
        ...
        .lc-card {
            ...
            border-radius: 16px;
            overflow: hidden;
            box-shadow: 0 4px 6px -1px rgba(0,0,0,.07), 0 20px 40px -10px rgba(99,102,241,.18);
        }
        ...
        .lc-invitee strong { font-weight: 700; }
        ...
        .lc-input:disabled { background: #f3f4f6; color: #6b7280; }
        .lc-pw-toggle {
        ...
        .lc-hint { font-size: 11px; color: #9ca3af; margin-top: 4px; }
...
<div class="lc-wrap">
    ...
    <div class="lc-card">
        <div class="lc-header">
            <div class="lc-logo"><i class="bi bi-envelope-open"></i></div>
            <h1 class="lc-title">You're invited</h1>
            <p class="lc-sub">Choose a password to activate your account</p>
        </div>

        <div class="lc-body">
            <div class="lc-invitee">
                <i class="bi bi-person-badge"></i>
                <span>Setting up the account for <strong>{{ $user->email }}</strong></span>
            </div>
            ...
            <form method="POST" action="{{ route('invitation.accept', $token) }}">
                ...
                <div class="lc-field">
                    <label for="name" class="lc-label">Name</label>
                    <div class="lc-input-wrap">
                        <i class="bi bi-person lc-input-icon"></i>
                        <input type="text" id="name" class="lc-input" value="{{ $user->name }}" disabled>
                    </div>
                </div>

                <div class="lc-field">
                    <label for="password" class="lc-label">Create Password</label>
                    <div class="lc-input-wrap">
                ...
                <div class="lc-field">
                    <label for="password_confirmation" class="lc-label">Confirm Password</label>
                    <div class="lc-input-wrap">
                        <i class="bi bi-lock-fill lc-input-icon"></i>
                        <input type="password" id="password_confirmation" name="password_confirmation"
                               class="lc-input" placeholder="••••••••"
                               required autocomplete="new-password">
                    </div>
                </div>

                <button type="submit" class="lc-btn">
                    <i class="bi bi-check2-circle"></i> Activate Account
                </button>
            </form>
        </div>
